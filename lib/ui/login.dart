...
import 'todo.dart';
import 'package:flutter_assignment_03/ui/mainSC.dart';
...
class _HomeState extends State<SecondScreen> {
  ...
  Widget build(BuildContext context) {
      ...
      IconButton(
        ...
        onPressed: () {
          Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => MainSc(count: count),
                ),
              );
        },
      ),
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text("Todo"), actions: <Widget>[listbtn[Index2]]),
      body: _children[Index2],
      bottomNavigationBar: BottomNavigationBar(
        onTap: onTabTapped, // new
        currentIndex: Index2, // new
        items: [
